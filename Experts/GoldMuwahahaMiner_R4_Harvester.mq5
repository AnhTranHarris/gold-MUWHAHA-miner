...
#property strict
#property description "Gold MUWHAHA R4: R3 session-adaptive regime controller with tighter 10/10 profit harvesting."
...
input group "R4 session-adaptive ATR"
