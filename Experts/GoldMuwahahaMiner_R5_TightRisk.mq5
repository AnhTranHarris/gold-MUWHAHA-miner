...
#property strict
#property description "Gold MUWHAHA R5: R4 session-adaptive regime controller with 30-pip hard stop and 8/8 harvesting."
...
input group "R5 session-adaptive ATR"
...
int OnInit()
{
   ...
   PrintFormat("%s initialized on %s; gap=%d SL=%d trail=%d activation=%d spread<=%d UTC-offset=%d",
               EA_TAG,
               _Symbol,
               InpGapPips,
               InpStopLossPips,
